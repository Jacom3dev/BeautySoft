...
class ResetPassword extends ResetPasswordNotification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Bienvenido a BeautySoft'))
            ...
            ->action(Lang::get('Cambiar contraseña'), url(config('APP_URL') . route('password.reset', ['token' => $this->token, 'email' => $notifiable->getEmailForPasswordReset()], false)))
