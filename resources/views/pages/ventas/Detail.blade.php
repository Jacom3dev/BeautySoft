@extends('layouts.app') @section('title', 'Ventas') @section('content')
<div class="container">
        ...
        <div class="col-4">
            <div class="card" style="width: 16rem; margin-left:100px;">
                <div class="card-body">
                    ...
                    <p class="card-title">Registrado por: </p>
                    <p class="card-text">{{ $Ventas->usuario->name }}</p>
                    <p class="card-title ">Nombre Cliente: </p>
                    <p class="card-text">{{ $Ventas->cliente->name }}</p>
                    <p class="card-title ">Precio Total: </p>
                    <p class="card-text">{{ $Ventas->price}}</p>
                    <p class="card-title ">Fecha: </p>
                    <p class="card-text">{{ $Ventas->created_at }}</p>
